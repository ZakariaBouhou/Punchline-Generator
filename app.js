...
// Les conneries - Pas faire attention
let sunglasses = document.querySelector('img');
sunglasses.className = 'd-none';
setTimeout(() => {
    sunglasses.className = 'w-25 position-absolute anim';
}, 3000);

let thugbird = document.querySelector('.bird');
thugbird.className = 'd-none';
setTimeout(() => {
    thugbird.className = 'w-25 position-absolute bird';
}, 6000);
